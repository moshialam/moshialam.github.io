...
1. [**Employee-Side Discrimination: Beliefs and Preferences**](papers/Alam_JMP_Oct21.pdf) (PhD JMP)  
   with Mehreen Mookerjee and Sanket Roy  
   **<a href="#" data-micromodal-trigger="abs_workerdisc" tabindex="0" class="text-info">[+Abstract]</a>** 
   [Online Appendix A-C](papers/OA_Alam_JMP_QE.pdf)  
   <p class="text-info">_R&R at Quantitative Economics_ <span class="badge bg-primary">_Updated July '25_</span></p>

2. [**The Unintended Benefits of Women's Empowerment on Household Sanitation**](papers/Agarwal_Alam_sanitation.pdf)  
   with Monica Agarwal
   **<a href="#" data-micromodal-trigger="abs_sanitation" tabindex="0" class="text-info">[+Abstract]</a>** 
   <a href="https://papers.ssrn.com/sol3/papers.cfm?abstract_id=4992568" class="text-info">[<i class="fas fa-file-pdf" style="color: #ec0909;"></i> SSRN]</a>  
   <p class="text-info">_R&R at Journal of Human Resources_ <span class="badge bg-primary">_Updated April '25_</span></p>

3. [**Labor Market Consequences of Pay-Equity Laws**](papers/Alam_JMP_payequity.pdf) (Post-doc JMP)  
   with Steven Lehrer and Nuno Souso Pereira  
   **<a href="#" data-micromodal-trigger="abs_payequity" tabindex="0" class="text-info">[+Abstract]</a>**  
   <p><span class="badge bg-primary">_Updated Aug '25_</span> <small><small>[_Under review_]</small></small></p>

4. **Computing Optimal Place‑Based Transfers with Direct Measurement of Geographic Variation in Marginal Utility of Income**  
   with Morris Davis and Jesse Gregory  
   <p><span class="badge bg-primary">_Draft coming soon!_</span></p>

---

<!-- Publications/Accepted Section -->
...
- ["**Increases in shared custody after divorce in the United States.**"](https://www.demographic-research.org/volumes/vol46/38/default.htm)  
  ...
  **<a href="#" data-micromodal-trigger="abs_divorce" tabindex="0" class="text-info">[+Abstract]</a>** 
