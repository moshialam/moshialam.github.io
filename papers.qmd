...
- [**Labor Market Consequences of Pay-Equity Laws**](papers/Alam_JMP_payequity.pdf) (Post-doc JMP) <p>with Steve Lehrer and Nuno Souso Pereira **<a href="#" data-micromodal-trigger="abs_payequity" tabindex="0" class="text-info">
  [+Abstract]
...
<!-- - **Labor Market Consequences of Pay-Equity Laws** <p>with Steve Lehrer and Nuno Souso Pereira <a href="https://moshialam.github.io/papers/Alam_JMP_payequity.pdf" target="_blank" class="btn btn-outline-info btn-sm"> <i class="fas fa-file-pdf" style='font-size:15px;color:darkred'></i> PDF  </a></p>  -->
---

#### <i class="bi bi-bookmark-check-fill"></i> Publications/Accepted 
<!-- - [**Employee-Side Discrimination: Beliefs and Preferences**](https://moshialam.github.io/papers/Alam_JMP_payequity.pdf) [PhD JMP]  <p>with Mehreen Mookerjee and Sanket Roy  **<a href="#" data-micromodal-trigger="abs_workerdisc" tabindex="0" class="text-info">
  [+Abstract]
</a>**  [[{{< fa code >}}Replication]](https://moshialam.github.io/papers) <p class="text-info"> _Quantitative Economics (2024) 17(1):1307-1346_ </p> -->
...
[<a class="text-info">  [{{< fa code >}}Replication]</a>](https://www.demographic-research.org/volumes/vol46/38/default.htm)  <p class="text-info"> *Demographic Research* 46 (2022): 1137-1162. <a class="text-info"> *"Editor's Choice"* article</a></p> 
---
