...
THis si the second part of a two-part sequence of Applied econometrics at the PhD level. Here I cover structural models and econometric methods with a focus on some types of labor and public economics problems. Having a comprehensive course on structural models is nearly impossible since  structural work fine tune the model to the specific theory and context. The key lies in identification, which can ultimately help us in doing counterfactuals. Hence, my emphasis will be mostly on identification, and primarily with discrete choice models (both static and dynamic) using estimation methods like MLE, GMM, SMM, and primarily indirect inference. I will cover some numerical optimization methods like gradient-based, derivative-free methods but mostly Nelder-Mead simplex algorithm. 
...
No textbook as such---its mostly papers, but I found [Kenneth Train's *Discrete Choice Methods with Simulation*](https://eml.berkeley.edu/books/choice2.html) very helpful when I was learning discrete choice models for the first time. Other references include *Structural Analysis of Discrete Data with Econometric Applications, Edited by Manski and McFadden*


Depending on time I will also talk about improving computational efficiency in `julia`, and discuss some of the workflows that have worked for me.
...
The readings are in not a particular order, although I will talk about identification in general first and then how is structural (model-based) approach different from reduced form (design-based) approach. Things that are not in particular order maybe specific topics & estimation routines and papers applying them.
...
- Allen and Rehbeck (2019) Identification with Additively Separable Heterogeneity. *Econometrica*

### Structural and Reduced Form Methods Discussions

- Andrews, A., Gentzkow, M., and Shapiro, J.M. (2020) "Transparency in Structural Research", *Journal of Business \& Economic Statistics*, 38:4, 711-722

- Andrews, A., Gentzkow, M., and Shapiro, J.M. (2020) "On the Informativeness of  Descriptive Statistics for Structural Estimates", *Econometrica*, Vol. 88, No. 6 
