...
Consider two researchers studying the same population and estimating the population model $y = \beta_0 + \beta_1 x + u$ with $\sigma^2 = 1$. Assume SLR.1-4 hold. The two researchers collect different samples:
