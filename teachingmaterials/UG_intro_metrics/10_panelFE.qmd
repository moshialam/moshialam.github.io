...
<!-- - Simultaneity: -->
<!-- - Unobserved heterogeneity $c_i$ (e.g., local “tough-on-crime” culture) confounds cross-sections. -->
...
- Simple OLS mixes within + between; biased if $Cov(x_{it}, c_i) \neq 0$.
    - **Between**: differences across $i$ (time-invariant) → drives pooled OLS bias  
