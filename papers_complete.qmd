...
/* Optional: Make the published paper stand out by spanning both columns */
/* Uncomment if you want the published paper to be full width */
/*
@media (min-width: 992px) {
  .paper-item.published {
    grid-column: 1 / -1;
...
/* Adjust for very wide screens - optional 3 column layout
...
<style>
/* Keep all your existing styles, then ADD/MODIFY these */
...
.paper-title-line a:hover {
  ...
  color: #7a4691;
  text-decoration: underline;
  /* OR use border instead of underline: */
  /* border-bottom: 1px solid #7a4691; */
}
...
<!-- <span class="badge-update" title="Updated April '25"><i class="bi bi-clock-history"></i></span> -->
</div>
</div>
