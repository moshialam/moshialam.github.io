...
- [**Labor Market Consequences of Pay-Equity Laws**](https://moshialam.github.io/papers/Alam_JMP_payequity.pdf) <p>with Steve Lehrer and Nuno Souso Pereira **<a href="#" data-micromodal-trigger="abs_payequity" tabindex="0" class="text-info">
  [+  Abstract]
</a>** 
- [**Employee-Side Discrimination: Beliefs and Preferences**](https://moshialam.github.io/papers/Alam_JMP_payequity.pdf)  <p>with Mehreen Mookerjee and Sanket Roy  **<a href="#" data-micromodal-trigger="abs_workerdisc" tabindex="0" class="text-info">
  [+  Abstract]
</a>**  <p class="text-info"> _R&R at Quantitative Economics_ </p>
...
## <i class="bi bi-bookmark-check-fill"></i> Publications/Forthcoming 
...
[<i class="text-danger">  [{{< fa code >}} Replication] </i>](https://www.demographic-research.org/volumes/vol46/38/default.htm)  <p class="text-info"> *Demographic Research* 46 (2022): 1137-1162. <a class="text-info"> *"Editor's Choice"* article</a> 
- [**Employee-Side Discrimination: Beliefs and Preferences**](https://moshialam.github.io/papers/Alam_JMP_payequity.pdf)  <p>with Mehreen Mookerjee and Sanket Roy  **<a href="#" data-micromodal-trigger="abs_workerdisc" tabindex="0" class="text-info">
  [+ Abstract]
</a>**  [ [{{< fa code >}} Replication] ](https://moshialam.github.io/papers) <p class="text-info"> _Conditionally aceepted at Quantitative Economics_ </p>
...
- **Identification in Models of Discrimination** <p>[subsumed in my PhD job market paper "Employee Side Discrimination"]</p>
